...
#define MSG_FARM_CARD_MENU LANG_TABLE_SELECT(MSG_FARM_CARD_MENU_LANG_TABLE)
...
extern const char* const MSG_RESET_CALIBRATE_E_LANG_TABLE[LANG_NUM];
#define MSG_RESET_CALIBRATE_E LANG_TABLE_SELECT(MSG_RESET_CALIBRATE_E_LANG_TABLE)
